...
<body>
    <div class="payment-container">
        <div class="payment-card">
            ...
            <button class="back-button" onclick="window.location.href='gt.php'">
    ...
    <script>
        ...
        async function initiateRazorpayPayment() {
            ...
            try {
                ...
                const response = await fetch('create_razorpay_order_new.php', {
                    ...
                    body: JSON.stringify({
                        temp_order_id: '<?php echo $temp_order_id; ?>',
                        amount: <?php echo $payment_amount; ?>,
                        currency: '<?php echo $currency; ?>',
                        email: '<?php echo $order_contact_email; ?>',
                        phone: '<?php echo $order_contact_phone; ?>',
        ...
        function handlePaymentResponse(response, isSuccess) {
            ...
            formData.append('temp_order_id', '<?php echo $temp_order_id; ?>');
