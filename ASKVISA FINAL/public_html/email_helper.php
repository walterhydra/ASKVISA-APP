...
function sendOrderConfirmationEmail($order_id, $recipient_email, $order_details = []) {
    ...
    try {
        ...
        // Bypass local SSL verification issues on Windows
        ...
        $mail->XMailer = 'Ask Visa Portal Mailer';
        ...
        // Improved Plain Text Fallback for Anti-Spam
        $alt_body = "Order Confirmed!\n\n";
        $alt_body .= "Dear Customer,\n\n";
        $alt_body .= "Thank you for choosing Ask Visa Portal. Your payment has been successfully verified, and your visa application is now being processed.\n\n";
        $alt_body .= "Order Summary:\n";
        $alt_body .= "- Order ID: #{$order_id}\n";
        $alt_body .= "- Status: Paid & Processed\n";
        $alt_body .= "- Date: " . date('d M Y, H:i A') . "\n\n";
        $alt_body .= "We have attached your invoice to this email. You can also view your application status and download your invoice from the portal anytime.\n\n";
        $alt_body .= "Best Regards,\nThe Ask Visa Portal Team\n\n";
        $alt_body .= "This is an automated message, please do not reply directly to this email.";
